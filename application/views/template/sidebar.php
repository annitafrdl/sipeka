<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="<?= base_url() ?>">BUMDES</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?= base_url() ?>">BMJ</a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?= base_url() ?>user">Data User</a></li>
                    <li><a class="nav-link beep beep-sidebar" href="<?= base_url() ?>jenis_kas">Jenis Kas</a></li>
                </ul>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-plug"></i> <span>Laporan</span></a>
                <ul class="dropdown-menu">
