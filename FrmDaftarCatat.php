...
<title>Daftar Pencatatan</title>
</head>
<body bgcolor="#C0C0FF">
<?php
include "Koneksi.php";
$query=mysqli_query ($connection,"SELECT * FROM tb_pencatatan order by Tanggal Asc")or die (mysql_error());
$jumlah = mysqli_num_rows($query);
?>
<center>
<font color='darkgreen' face='Tahoma' size=5><b><br>DAFTAR PENCATATAN</b></font><br>
<a href="EntryDataCatat.php">Tambah Data Catat</a><br>
